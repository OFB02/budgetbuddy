...
export default function MonthlyPlannerScreen({ onBack }) {
  ...
  const currencies = [
    ...
    { symbol: 'kr', code: 'SEK', countries: ['Sweden'], flag: '🇸🇪' },
    { symbol: 'kr', code: 'NOK', countries: ['Norway'], flag: '🇳🇴' },
    { symbol: 'kr', code: 'DKK', countries: ['Denmark', 'Greenland', 'Faroe Islands'], flag: '🇩🇰' },
    ...
    { symbol: 'Rp', code: 'PKR', countries: ['Pakistan'], flag: '🇵🇰' },
